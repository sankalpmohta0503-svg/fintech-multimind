...
const DataTable = ({ columns, rows, getRowKey, emptyMessage = 'No records available.', className = '' }) => (
  <div className={`overflow-x-auto rounded border border-[#BFDBFE] ${className}`}>
